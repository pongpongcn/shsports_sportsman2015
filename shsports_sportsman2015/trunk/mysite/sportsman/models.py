...
class StudentEvaluation(models.Model):
    ...
    p_20m = models.DecimalField('累积概率 20米冲刺跑', max_digits=2, decimal_places=2, null=True, blank=True)
    p_su = models.DecimalField('累积概率 仰卧起坐', max_digits=2, decimal_places=2, null=True, blank=True)
    p_ls = models.DecimalField('累积概率 俯卧撑', max_digits=2, decimal_places=2, null=True, blank=True)
    p_rb = models.DecimalField('累积概率 直身前屈', max_digits=2, decimal_places=2, null=True, blank=True)
    p_lauf = models.DecimalField('累积概率 六分跑', max_digits=2, decimal_places=2, null=True, blank=True)
    p_ball = models.DecimalField('累积概率 投掷', max_digits=2, decimal_places=2, null=True, blank=True)
    p_height = models.DecimalField('累积概率 身高', max_digits=2, decimal_places=2, null=True, blank=True)
    p_weight = models.DecimalField('累积概率 体重', max_digits=2, decimal_places=2, null=True, blank=True)
    p_bmi = models.DecimalField('累积概率 BMI', max_digits=2, decimal_places=2, null=True, blank=True)
    
    potential_badminton = models.DecimalField('运动潜质 羽毛球', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_basketball = models.DecimalField('运动潜质 篮球', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_soccer = models.DecimalField('运动潜质 足球', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_gymnastics = models.DecimalField('运动潜质 体操', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_canoe = models.DecimalField('运动潜质 皮艇/划艇', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_discus = models.DecimalField('运动潜质 铁饼', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_shot_put = models.DecimalField('运动潜质 铅球', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_pole_vault = models.DecimalField('运动潜质 撑杆跳', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_high_jump = models.DecimalField('运动潜质 跳高', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_javelin = models.DecimalField('运动潜质 标枪', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_long_jump = models.DecimalField('运动潜质 跳远', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_huerdles = models.DecimalField('运动潜质 跨栏', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_sprint = models.DecimalField('运动潜质 短跑', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_rowing = models.DecimalField('运动潜质 赛艇', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_swimming = models.DecimalField('运动潜质 游泳', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_tennis = models.DecimalField('运动潜质 网球', max_digits=3, decimal_places=3, null=True, blank=True)
    potential_table_tennis = models.DecimalField('运动潜质 乒乓球', max_digits=3, decimal_places=3, null=True, blank=True)
