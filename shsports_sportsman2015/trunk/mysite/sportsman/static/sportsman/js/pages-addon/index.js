$(function () {
	...
	$('#talent_local_global_percentage_chart').highcharts($.extend({}, percentage_chart_options, {series: talent_local_global_series}));
	$('#frail_local_global_percentage_chart').highcharts($.extend({}, percentage_chart_options, {series: frail_local_global_series}));
});